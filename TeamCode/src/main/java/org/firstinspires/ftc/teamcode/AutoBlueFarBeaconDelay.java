 ...
 */
 @Autonomous(name = "Blue_Far_Beacon_Delay", group = "7079")

public class AutoBlueFarBeaconDelay extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        FTrobot.driveTrain.SuperAuto("blue", true, 1, false);
    }
}
