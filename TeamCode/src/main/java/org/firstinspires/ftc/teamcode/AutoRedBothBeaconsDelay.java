 ...
 */
 @Autonomous(name = "Red_Both_Beacons_Delay", group = "7079")

public class AutoRedBothBeaconsDelay extends LinearOpMode {
 ...
 */
        FTrobot.driveTrain.SuperAuto("red", true, 2, false);
        /*
        //Auto Start
